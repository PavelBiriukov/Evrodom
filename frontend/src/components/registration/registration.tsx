                                    ...
                                    <div className="form">
                                        <div>
                                            ...
                                            <div className="btn_wrapper">
                                                <button className={cl.button} onClick={handleRegistration}>Зарегистрироваться</button>
